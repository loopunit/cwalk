...
int join_multiple()
{
  ...
  length = cwk_path.join_multiple(paths, buffer, sizeof(buffer));
...
int join_relative_back_after_root()
{
  ...
  length = cwk_path.join("this\\", "C:\\..\\..\\is\\a\\test\\", buffer,
    sizeof(buffer));
...
int join_back_after_root()
{
  ...
  cwk_path.set_style(CWK_STYLE_WINDOWS);
  length = cwk_path.join("C:\\this\\path", "C:\\..\\is\\a\\test\\", buffer,
    sizeof(buffer));
...
int join_two_unc()
{
  ...
  cwk_path.set_style(CWK_STYLE_WINDOWS);
  length = cwk_path.join("\\\\server\\unc\\path", "\\\\server2\\unc\\path",
...
int join_two_absolute()
{
  ...
  cwk_path.set_style(CWK_STYLE_UNIX);
  length = cwk_path.join("/first", "/second", buffer, sizeof(buffer));
...
int join_empty()
{
  ...
  cwk_path.set_style(CWK_STYLE_UNIX);
  length = cwk_path.join("hello", "..", buffer, sizeof(buffer));
...
int join_navigate_back()
{
  ...
  cwk_path.set_style(CWK_STYLE_UNIX);
  length = cwk_path.join("hello/there", "..", buffer, sizeof(buffer));
